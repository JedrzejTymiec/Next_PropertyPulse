...
const MessagesPage = async () => {
  ...
  return (
    <section aria-labelledby="messages-header" className="bg-blue-50">
      <div className="container m-auto py-24 max-w-6xl">
        <div className="bg-white px-6 py-8 mb-4 shadow-md rounded-md border m-4 md:m-0">
          <h1 id="messages-header" className="text-3xl font-bold mb-4">
            Your messages
          </h1>
          <div className="space-y-4">
            {messages.length === 0 ? (
              <p role="status">You have no messages</p>
            ) : (
